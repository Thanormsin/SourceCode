...
const char* rigname  = "ESP32-Nam02";                     // Change this if you want to display a custom rig name in the Wallet
...
//Pulse Pool
const char * host4 = "149.91.88.18"; // Static server IP
...
//Beyond Pool-1
const char * host1 = "50.112.145.154"; // Static server IP
const int port1 = 6000;
