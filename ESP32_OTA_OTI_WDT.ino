...
const char* ssid2     = "Tha1-2.4G";        //<-- ใส่ชือ Wifi หลัก
...
const char* ssid     = "Tha1-2.4G";            // Change this to your WiFi SSID
const char* password = "0819065291";        // Change this to your WiFi password

//const char* ducouser = "Siwadol";  // Change this to your Duino-Coin username
const char* BoardName  = "ESP32-Board-01";                     // Change this if you want to display a custom rig name in the Wallet
...
//      esp_task_wdt_reset();
//      Serial.println("");
//      Serial.println("CORE1 Asking for a new job for user: " + String(ducouser)+ "/" + String(BoardName)+ "/" + String(host) + "/" + String(port));
//      client1.flush();
...
//          }
//          client1.flush();
//          client1.print(String(iJob1) + "," + String(HashRate1) + ",ESP32 CORE1 Miner v2.63," + String(BoardName) + "," + String((char*)ID)); // Send result to server
...
//      esp_task_wdt_reset();
//      Serial.println("");
//      Serial.println("CORE2 Asking for a new job for user: " + String(ducouser)+ "/" + String(BoardName)+ "/" + String(host) + "/" + String(port));
//      client.flush();
...
//          }
//          client.flush();
//          client.print(String(iJob) + "," + String(HashRate) + ",ESP32 CORE2 Miner v2.63," + String(BoardName) + "," + String((char*)ID)); // Send result to server
...
void setup() {
  ...
  Serial.println("\n\nOTI_OTA_WDT_2WiFi Auto Update Ver. 1.1");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //ตรวจสอบตอนเสียบปลั๊ก/เปิดเครื่องครั้งแรก
...
void loop() {
  ...
  if (button_boot.pressed) { //to connect wifi via Android esp touch app 
    Serial.println("Starting Manual Update Request..");
    FirmwareVersionCheck();
    //firmwareUpdate();
